...
if __name__ == "__main__":
    ...
    IMG_DIR = "/media/dp/LinuxData/DataSets/GuanGan/RJQ/new_label/image"
    XML_DIR = "/media/dp/LinuxData/DataSets/GuanGan/RJQ/new_label/Annotations"

    AUG_XML_DIR = "/media/dp/LinuxData/DataSets/GuanGan/RJQ/new_label/img_aug" # 存储增强后的XML文件夹路径
    #mkdir(AUG_XML_DIR)

    AUG_IMG_DIR = "/media/dp/LinuxData/DataSets/GuanGan/RJQ/new_label/img_aug" # 存储增强后的影像文件夹路径
    #mkdir(AUG_IMG_DIR)
